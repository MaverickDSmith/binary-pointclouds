...
class CustomCNN(pl.LightningModule):
    def __init__(self, num_classes, num_slices):
        ...
        # # Norm Layers
        # # Experiment with other Normalizations?
        # self.bn1 = nn.BatchNorm2d(4, dtype=torch.bfloat16)
        # self.bn2 = nn.BatchNorm2d(8, dtype=torch.bfloat16)
        # self.bn3 = nn.BatchNorm2d(16, dtype=torch.bfloat16)
        # self.bn1 = nn.BatchNorm1d(4, dtype=torch.bfloat16)
        # self.bn2 = nn.BatchNorm1d(8, dtype=torch.bfloat16)
