...
def process_off_file(off_file_path, kdtree_rle_flag, voxel_rle_flag, voxel_sc_flag):
    ...
    # Binary Stuff
    if kdtree_rle_flag:
        kdtree_rle_data, kdtree_rle_points_64, min_bin_bound, max_bin_bound = binary_your_pointcloud(point_cloud_normalized, 64, max_bound, min_bound)
        kdtree_rle_data = rle_encode_variable_length(kdtree_rle_data, min_bin_bound, max_bin_bound)
        package[0] = kdtree_rle_data



    if voxel_rle_flag:
        voxel_rle_data, voxel_rle_points_64, min_bin_bound, max_bin_bound = binary_your_pointcloud_test(point_cloud_normalized, 64, max_bound, min_bound)
        voxel_rle_data = rle_encode_variable_length_test(voxel_rle_data, min_bin_bound, max_bin_bound)
        package[1] = voxel_rle_data


    if voxel_sc_flag:
        voxel_sc_data, voxel_sc_points_64, min_bin_bound, max_bin_bound = binary_your_pointcloud_test(point_cloud_normalized, 64, max_bound, min_bound)
        voxel_sc_data = sc_encode_variable_length_with_bounds(voxel_sc_data, min_bin_bound, max_bin_bound)
        package[2] = voxel_sc_data
